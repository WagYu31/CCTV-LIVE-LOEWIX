...
<head>
  ...
  <style>
    ...
    /* ===== FULLSCREEN LOEWIX ENTERPRISE LOGIN GATE ===== */
    #loewix-login-gate {
      min-height: 100vh;
      width: 100%;
      display: flex;
      align-items: center;
      justify-content: center;
      background: radial-gradient(circle at 50% 20%, #0d1e48 0%, #060b1c 65%, #020612 100%);
      position: fixed;
      top: 0;
      left: 0;
      right: 0;
    ...
    .login-glow-orb {
      ...
      height: 600px;
      border-radius: 50%;
      background: radial-gradient(circle, rgba(0, 210, 255, 0.15) 0%, rgba(0, 102, 255, 0) 70%);
      top: -150px;
      left: 50%;
      transform: translateX(-50%);
      pointer-events: none;
    ...
    .login-card-container {
      ...
      border-radius: 24px;
      padding: 36px 30px;
      box-shadow: 0 25px 60px -15px rgba(0, 0, 0, 0.8), 0 0 35px rgba(0, 210, 255, 0.15);
    ...
    .login-eye-btn:hover { color: #00d2ff; }
...
<body>
  ...
  <div id="loewix-login-gate" style="display: flex;">
    ...
    <div class="login-card-container">
      <div class="text-center mb-4">
        <img src="assets/image/logo-loewix-white.png" alt="Loewix CCTV" style="height: 44px; max-width: 170px; object-fit: contain; margin-bottom: 12px; filter: drop-shadow(0 4px 15px rgba(0,210,255,0.4));">
        <h2 style="color: #ffffff; font-weight: 800; font-size: 19px; letter-spacing: 0.5px; margin-bottom: 6px;">LOEWIX ENTERPRISE</h2>
        <p style="color: #94a3b8; font-size: 13px; line-height: 1.5; margin-bottom: 0;">Silakan login untuk mengakses live surveillance grid CCTV</p>
      </div>

      <form id="formGateLogin" onsubmit="submitGateLogin(event)">
        <div class="login-input-group">
          <label><i class="fas fa-envelope text-info mr-1"></i> Email Akun:</label>
          <div class="login-input-wrapper">
            <i class="fas fa-envelope input-icon"></i>
            <input type="email" id="gate-login-email" placeholder="admin@loewixcctv.com" required autocomplete="email">
          </div>
        </div>

        <div class="login-input-group mb-3">
          <label><i class="fas fa-key text-info mr-1"></i> Password:</label>
          <div class="login-input-wrapper">
            <i class="fas fa-lock input-icon"></i>
            <input type="password" id="gate-login-password" placeholder="••••••••" required autocomplete="current-password">
            <i class="fas fa-eye login-eye-btn" id="gate-toggle-pwd" onclick="toggleGatePasswordVisibility()" title="Tampilkan / Sembunyikan Password"></i>
          </div>
        </div>

        <div class="p-3 rounded mb-4" style="background: rgba(56, 189, 248, 0.08); border: 1px solid rgba(56, 189, 248, 0.25); border-radius: 12px;">
          <div style="font-size: 11px; font-weight: 700; color: #38bdf8; margin-bottom: 8px; display: flex; align-items: center; gap: 5px;">
            <i class="fas fa-bolt"></i> AKUN AKSES DEMO:
          </div>
          <div style="display: flex; flex-direction: column; gap: 6px;">
            <button type="button" class="quick-demo-btn" onclick="fillGateDemo('admin@loewixcctv.com', 'admin123')">
              <span>🛡️ <strong>Super Admin</strong></span>
              <span style="opacity: 0.8; font-size: 10px;">admin@loewixcctv.com</span>
            </button>
            <button type="button" class="quick-demo-btn" onclick="fillGateDemo('customer@jayasentosa.com', 'customer123')">
              <span>🏢 <strong>Customer</strong></span>
              <span style="opacity: 0.8; font-size: 10px;">customer@jayasentosa.com</span>
            </button>
          </div>
        </div>

        <button type="submit" id="btn-gate-submit" class="login-btn-submit">
          <i class="fas fa-sign-in-alt"></i> MASUK KE SISTEM
        </button>

        <div class="text-center mt-3" style="font-size: 11px; color: #64748b; display: flex; align-items: center; justify-content: center; gap: 6px;">
          <i class="fas fa-shield-alt text-success"></i> 256-Bit Encrypted Secure Live Stream
        </div>
      </form>
    </div>
  </div>
      ...
      <div class="container overlay-content">
        <div class="weight-footer-item-con">
          <div class="row wow fadeInUp">
            <div
              class="col-lg-4 col-md-12 col-12 text-lg-left text-md-center">
              <div
                class="weight-footer-item weight-footer-item1 mb-lg-0 mb-3">
  ...
  <script nonce="yoE9kVwZ3muQRX/H9UUiLA==">
    ...
    // WiFi Location Data - Updated 2025
    // Format koordinat: latitude dan longitude dalam format desimal standar
    // Data source: Dinas Komunikasi dan Informatika Kota Pematangsiantar
    const wifiLocations = [{
      ...
      },
      {
        ...
        lat: 2.95600277,
        lng: 99.06133892,
        address: 'Jl. Sutomo III, Proklamasi, Kec. Siantar Bar., Kota Pematang Siantar, Sumatera Utara 21144',
      },
      {
        name: 'Ruang Data',
        lat: 2.95636923,
        lng: 99.06158861,
        address: 'Jl. Merdeka, Proklamasi, Kec. Siantar Bar., Kota Pematang Siantar, Sumatera Utara 21144',
      },
      {
      ...
      {
        name: 'Lapangan Merdeka (1)',
        lat: 2.95719800,
        lng: 99.06104007,
        address: 'Proklamasi, Kec. Siantar Bar., Kota Pematang Siantar, Sumatera Utara',
      },
      {
        name: 'Lapangan Merdeka (2)',
        lat: 2.95719800,
        lng: 99.06104007,
        address: 'Proklamasi, Kec. Siantar Bar., Kota Pematang Siantar, Sumatera Utara',
      },
      {
        name: 'Lapangan Merdeka (3)',
        lat: 2.95719800,
        lng: 99.06104007,
        address: 'Proklamasi, Kec. Siantar Bar., Kota Pematang Siantar, Sumatera Utara',
      },
      {
        name: 'Mall Pelayanan Publik Ramayana (1)',
        lat: 2.96031210,
        lng: 99.07384784,
        address: 'Jl. Sutomo, Pahlawan, Kec. Siantar Tim., Kota Pematang Siantar, Sumatera Utara 21136',
      },
      {
        name: 'Mall Pelayanan Publik Ramayana (2)',
        lat: 2.96031210,
        lng: 99.07384784,
        address: 'Jl. Sutomo, Pahlawan, Kec. Siantar Tim., Kota Pematang Siantar, Sumatera Utara 21136',
      },
      {
        ...
        lat: 2.94433584,
        lng: 99.04154687,
        address: 'Jl. Sisingamangaraja, Setia Negara, Kec. Siantar Sitalasari, Kota Pematang Siantar, Sumatera Utara 21139',
      },
      {
        name: 'Taman Beo (2)',
        lat: 2.94433584,
      ...
      },
      {
        ...
        lat: 2.96233333,
        lng: 99.04733351,
        address: 'Pematang Siantar, Bukit Sofa, Kec. Siantar Sitalasari, Kota Pematang Siantar, Sumatera Utara 21139',
      },
      {
        name: 'USI (Lapangan Bola)',
        lat: 2.96226597,
        lng: 99.04566701,
        address: 'Pematang Siantar, Bah Kapul, Kec. Siantar Sitalasari, Kota Pematang Siantar, Sumatera Utara 21139',
      },
      {
        name: 'Dekranasda',
        lat: 2.95725459,
        lng: 99.06199533,
        address: 'Jl. Merdeka No.3, Proklamasi, Kec. Siantar Bar., Kota Pematang Siantar, Sumatera Utara',
      },
      {
        name: 'Kantor Pramuka',
        lat: 2.97394008,
        lng: 99.07093801,
        address: 'Jl. Meranti, Kahean, Kec. Siantar Utara, Kota Pematang Siantar, Sumatera Utara',
      },
      {
        name: 'Kantor Bawaslu',
        lat: 2.95168450,
        lng: 99.05311881,
        address: 'Jl. Raya No.29, Simarito, Kec. Siantar Bar., Kota Pematang Siantar, Sumatera Utara 21112',
      },
      {
        name: 'Kantor Ephorus GKPS',
        lat: 2.97314287,
        lng: 99.05388837,
        address: 'Kantor Pusat GKPS, Bane, Kec. Siantar Utara, Kota Pematang Siantar, Sumatera Utara 21143',
      },
      {
        name: 'HKBP Jalan Gereja',
        lat: 2.94944682,
        lng: 99.06159191,
        address: 'Pematang Siantar, Kristen, Kec. Siantar Sel., Kota Pematang Siantar, Sumatera Utara',
      },
      {
        name: 'Univ. Nommensen (1)',
        lat: 2.96125998,
        lng: 99.07956946,
        address: 'Pematang Siantar, Siopat Suhu, Kec. Siantar Tim., Kota Pematang Siantar, Sumatera Utara',
      },
      {
        name: 'Univ. Nommensen (2)',
        lat: 2.96127779,
        lng: 99.07952715,
        address: 'Pematang Siantar, Siopat Suhu, Kec. Siantar Tim., Kota Pematang Siantar, Sumatera Utara',
      },
      {
        ...
        lat: 2.95809029,
        lng: 99.05803810,
        address: 'Pematang Siantar, Banjar, Kec. Siantar Bar., Kota Pematang Siantar, Sumatera Utara 21143',
      },
      {
        name: 'Muhammadiyah',
        lat: 2.96490508,
        lng: 99.07511163,
        address: 'Jl. Ahmad Yani No.37, Asuhan, Kec. Siantar Tim., Kota Pematang Siantar, Sumatera Utara',
      },
      {
        name: 'Panti Asuhan ELIM',
        lat: 2.97403507,
        lng: 99.07658646,
        address: 'Pematang Siantar, Asuhan, Kec. Siantar Tim., Kota Pematang Siantar, Sumatera Utara 21137',
      },
      {
        name: 'Mesjid Raya',
        lat: 2.95409941,
        lng: 99.05726958,
        address: 'Jl. Masjid No.2, Timbang Galung, Kec. Siantar Bar., Kota Pematang Siantar, Sumatera Utara 21143',
      },
      {
        name: 'Kantor Wali Kota (lt 1)',
        lat: 2.95654382,
        lng: 99.06171608,
        address: 'Jl. Merdeka, Proklamasi, Kec. Siantar Bar., Kota Pematang Siantar, Sumatera Utara 21144',
      },
      {
        name: 'Pesantren Darusalam',
        lat: 2.99093463,
        lng: 99.07375010,
        address: 'Pematang Siantar, Pd. Sayur, Kec. Siantar Martoba, Kota Pematang Siantar, Sumatera Utara 21137',
      },
      {
        name: 'Dinas Dukcapil-1',
        lat: 2.94599684,
        lng: 99.06870322,
        address: 'Jl. Pisang, Sukamaju, Kec. Siantar Marihat, Kota Pematang Siantar, Sumatera Utara 21121',
      },
      {
        name: 'Dinas Dukcapil-2',
        lat: 2.94599684,
        lng: 99.06870322,
        address: 'Jl. Pisang, Sukamaju, Kec. Siantar Marihat, Kota Pematang Siantar, Sumatera Utara 21121',
      },
      {
        name: 'Diskominfo (Media Center)',
        lat: 2.95820564,
        lng: 99.06973778,
        address: 'Pematang Siantar, Simalungun, Kec. Siantar Sel., Kota Pematang Siantar, Sumatera Utara',
      },
      {
        name: 'RSUD (Ruang Pendaftaran Pasien)',
        lat: 2.95820564,
        lng: 99.06973778,
        address: 'Pematang Siantar, Simalungun, Kec. Siantar Sel., Kota Pematang Siantar, Sumatera Utara',
      },
      {
        name: 'RSUD (Poliklinik)',
        lat: 2.95820564,
        lng: 99.06973778,
        address: 'Pematang Siantar, Simalungun, Kec. Siantar Sel., Kota Pematang Siantar, Sumatera Utara',
      },
      {
        name: 'BPKPD (Kantor Pelayanan PBB)',
        lat: 2.95656465,
        lng: 99.06229304,
        address: 'Jl. Merdeka No.6, Proklamasi, Kec. Siantar Bar., Kota Pematang Siantar, Sumatera Utara',
      },
      {
        name: 'Satpol PP',
        lat: 2.95496130,
        lng: 99.05968084,
        address: 'Pematang Siantar, Proklamasi, Kec. Siantar Bar., Kota Pematang Siantar, Sumatera Utara',
      },
      {
        name: 'DPRD Sekwan',
        lat: 2.95518437,
      ...
      {
        name: 'Tugu Sangnawaluh',
        lat: 2.96064691,
        lng: 99.07418229,
        address: 'Jl. Sangnawaluh, Pahlawan, Kec. Siantar Tim., Kota Pematang Siantar, Sumatera Utara 21136',
      },
      {
        name: 'Taman Simpang 2',
        lat: 2.93177053,
        lng: 99.04609683,
        address: 'Jl. Saribu Dolok, Nagahuta Tim., Kec. Siantar Marimbun, Kota Pematang Siantar, Sumatera Utara 21126',
      },
      {
        name: 'STT GPDI',
        lat: 2.96206406,
        lng: 99.08109008,
        address: 'Jl. Sangnawaluh, Siopat Suhu, Siantar Timur, Pematang Siantar City, North Sumatra 21139',
      },
      {
        name: 'Dinas Pemadaman Kebakaran dan Penyelamatan',
        lat: 2.95227658,
        lng: 99.06273569,
    ...
    async function monitorVideoPlayer(playerId) {
      ...
      // Skip jika player tidak aktif atau tidak visible
      if (!player.src || player.style.display === 'none' || player.classList.contains('hidden-iframe')) {
        return;
      }
    ...
    function playMediaMTXCCTV(element, playerId, thumbId) {
      ...
      // MediaMTX HLS mode - semua kamera pakai HLS via MediaMTX server
                ...
                if (data.fatal) {
                  switch(data.type) {
                    case Hls.ErrorTypes.NETWORK_ERROR:
                      netErrorCount++;
                      if (netErrorCount <= 3) {
                        console.log('[Stream] Recovering network error (attempt ' + netErrorCount + ')...');
                        setTimeout(() => hls.startLoad(), 1500);
                      } else {
                        console.error('[Stream] Network error exceeded retry limit.');
                        hls.destroy();
                        if (bufferingOverlay) bufferingOverlay.style.display = 'none';
                        if (thumb) {
                          thumb.style.display = 'flex';
                    ...
                    case Hls.ErrorTypes.MEDIA_ERROR:
                      ...
                      if (mediaErrorCount <= 2) {
                        console.log('[Stream] Recovering media error (attempt ' + mediaErrorCount + ')...');
                        hls.recoverMediaError();
                      } else {
                        console.error('[Stream] Media error unrecoverable.');
                        hls.destroy();
                        if (bufferingOverlay) bufferingOverlay.style.display = 'none';
                        if (thumb) {
                          thumb.style.display = 'flex';
    ...
    function initWiFiMap() {
      ...
      try {
        ...
        const siantarCoords = [2.9568, 99.0619];

        mapWifi = L.map('mapid', {
          zoomControl: false,
          attributionControl: true,
        }).setView(siantarCoords, 14);

        L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
          attribution: 'Map data © Diskominfo Kota Pematangsiantar',
          maxZoom: 19,
        }).addTo(mapWifi);
