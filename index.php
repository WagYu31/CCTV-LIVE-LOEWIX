...
<head>
  ...
  <style>
    ...
    /* Optimize video rendering for many concurrent videos */
...
<body>
            ...
            <div class="vms-encode-body">
              ...
              <div class="vms-encode-grid">
                ...
                <div class="vms-encode-param-row">
                  ...
                  <div>
                    <select id="enc-main-compression" class="vms-encode-select">
                  ...
                  <div>
                    <select id="enc-extra-compression" class="vms-encode-select">
                ...
                <div class="vms-encode-param-row">
                  ...
                  <div>
                    <select id="enc-main-resolution" class="vms-encode-select">
                  ...
                  <div>
                    <select id="enc-extra-resolution" class="vms-encode-select">
                ...
                <div class="vms-encode-param-row">
                  ...
                  <div>
                    <select id="enc-main-quality" class="vms-encode-select">
                  ...
                  <div>
                    <select id="enc-extra-quality" class="vms-encode-select">
                      <option value="high" selected>high</option>
                      <option value="best">best</option>
                      <option value="better">better</option>
                      <option value="good">good</option>
                ...
                <div class="vms-encode-param-row">
                  ...
                  <div>
                    <select id="enc-main-smart" class="vms-encode-select">
  ...
  <script nonce="yoE9kVwZ3muQRX/H9UUiLA==">
    ...
    async function openEncodeModal(channelId) {
      currentEncodeChannel = parseInt(channelId) || 1;
      const modal = document.getElementById('cameraEncodeModal');
      if (!modal) return;

      // Populate channel selector with active cameras if available
      const chanSelect = document.getElementById('encode-channel');
      if (chanSelect && typeof mediamtxData !== 'undefined' && Array.isArray(mediamtxData) && mediamtxData.length > 0) {
        chanSelect.innerHTML = '';
        mediamtxData.forEach((cam, index) => {
          const chNum = cam.id || (index + 1);
          const opt = document.createElement('option');
          opt.value = chNum;
          opt.textContent = `${chNum} - ${cam.title || 'Camera ' + chNum}`;
          chanSelect.appendChild(opt);
        });
        chanSelect.value = currentEncodeChannel;
      }
    ...
    async function loadChannelEncodeConfig(channel) {
      currentEncodeChannel = parseInt(channel) || 1;
      try {
        const res = await fetch(`api/camera_encode.php?action=get&channel=${currentEncodeChannel}`);
      ...
      try {
        ...
        if (data.success) {
          if (typeof showCCTVToast === 'function') {
            showCCTVToast(data.message || 'Konfigurasi Encode berhasil disimpan!', 'success');
          } else {
            alert(data.message || 'Konfigurasi Encode berhasil disimpan!');
          }
          closeEncodeModal();
        } else {
