...
<head>
  ...
  <style>
    ...
    .btn-gate-submit-main:hover::before {
      left: 100%;
    }

    .btn-gate-submit-main:active {
      transform: translateY(0);
    }
...
<body>
    ...
    <div class="gate-auth-panel">
      <div class="gate-auth-card">
        ...
        <div class="form-role-tabs">
          ...
          <button type="button" class="form-role-tab" id="tab-role-customer" onclick="switchLoginRole('customer@jayasentosa.com', 'customer123', this)">
            <i class="fas fa-building"></i> <span>Customer</span>
          </button>
        </div>
        ...
        <form id="formGateLogin" onsubmit="submitGateLogin(event)">
          ...
          <div class="form-group-custom">
            ...
            <div class="form-input-container">
              ...
              <i class="fas fa-eye btn-password-toggle" id="gate-toggle-pwd" onclick="toggleGatePasswordVisibility()" title="Lihat / Sembunyikan Password"></i>
            </div>
          </div>
          ...
          <div style="margin-bottom: 20px;">
            ...
            <div class="demo-accounts-pill-container">
              <div class="demo-account-pill active-pill" id="pill-admin" onclick="switchLoginRole('admin@loewixcctv.com', 'admin123', document.getElementById('tab-role-superadmin'))">
                <div class="demo-pill-avatar" style="background: rgba(234, 179, 8, 0.15); color: #eab308;">
                  <i class="fas fa-shield-alt"></i>
                </div>
                <div>
                  <div class="demo-pill-role">Super Admin</div>
                  <div class="demo-pill-email">admin@loewixcctv.com</div>
                </div>
              </div>
              <div class="demo-account-pill" id="pill-customer" onclick="switchLoginRole('customer@jayasentosa.com', 'customer123', document.getElementById('tab-role-customer'))">
                <div class="demo-pill-avatar" style="background: rgba(56, 189, 248, 0.15); color: #38bdf8;">
                  <i class="fas fa-building"></i>
                </div>
                <div>
                  <div class="demo-pill-role">PT. Jaya Sentosa</div>
                  <div class="demo-pill-email">customer@jayasentosa.com</div>
                </div>
              </div>
            </div>
          </div>

          <button type="submit" id="btn-gate-submit" class="btn-gate-submit-main">
            <i class="fas fa-sign-in-alt"></i> <span>MASUK KE SISTEM MONITORING</span>
          </button>
  ...
  <script>
    ...
    function switchLoginRole(email, pwd, tabElem) {
      ...
      // Update tabs UI
      document.querySelectorAll('.form-role-tab').forEach(t => t.classList.remove('active'));
      if (tabElem) tabElem.classList.add('active');

      // Update pills UI
      const pillAdmin = document.getElementById('pill-admin');
      const pillCustomer = document.getElementById('pill-customer');
      if (email.includes('admin')) {
        if (pillAdmin) pillAdmin.classList.add('active-pill');
        if (pillCustomer) pillCustomer.classList.remove('active-pill');
      } else {
        if (pillCustomer) pillCustomer.classList.add('active-pill');
        if (pillAdmin) pillAdmin.classList.remove('active-pill');
      }
    }
