              ...
              <div class="col-lg-5 col-md-5 col-sm-12">
                <div class="banner-right-con wow slideInRight" style="position: relative; text-align: center;">
                  <figure class="mb-0" style="position: relative; display: inline-block;">
                    <img
                      src="assets/image/loewix_hero_cctv_camera.png?v=2"
                      alt="Loewix CCTV Camera"
                      class="img-fluid"
                      style="max-width: 100%; height: auto; filter: drop-shadow(0 15px 30px rgba(0,0,0,0.6)); transform: scale(1.1); transition: all 0.5s ease;"
                      loading="eager" />
                  </figure>
                </div>
              </div>
  ...
  <script nonce="yoE9kVwZ3muQRX/H9UUiLA==">
    ...
    function initCCTVMap() {
      ...
      try {
        ...
        const siantarCoords = [-6.2088, 106.8456];

        mapCCTV = L.map('map', {
          zoomControl: false,
          attributionControl: true,
        }).setView(siantarCoords, 13);
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      (function setupVideoThumbnailClickDelegation() {
        ...
        ['cctv-container', 'pasar-horas-container', 'terminal-tanjung-pinggir-container'].forEach(function(cid) {
          ...
          if (node) node.addEventListener('click', onGridThumbClick);
        });
      })();
